...
import { ImportarVentas3Section } from '../importar-ventasV2/components/ImportarVentas3Section';

export default function ImportarVentasV3Page() {
  ...
  useEffect(() => {
    const loadRestrictions = async () => {
      try {
        ...
        console.error('Error al cargar restricciones (IV3):', error);
      }
    };
    loadRestrictions();
  }, []);
  ...
  useEffect(() => {
    const loadFilterOptions = async () => {
      try {
        ...
        console.error('Error al cargar opciones de filtros (IV3):', error);
      } finally {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="px-6 py-4">
          <h1 className="text-xl font-semibold text-gray-800">Importar Ventas 3 - Optimizador de Producción</h1>
          <p className="text-sm text-gray-500 mt-0.5">Flujo unificado semanal/mensual con ajuste y revisión final</p>
        </div>
      </div>
      <div className="p-6">

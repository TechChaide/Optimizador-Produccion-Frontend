  ...
  return (
    <Card>
      <CardHeader className="flex items-center justify-between">
        <div>
          <CardTitle>Listado de Tipos de Ausentismo</CardTitle>
          <CardDescription>Tipos de ausentismo registrados en el sistema.</CardDescription>
        </div>
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? renderSkeleton() : paginated.map(record => (
                <TableRow key={record.codigo_tipo_ausentismo}>
                  <TableCell className="font-medium">{record.codigo_tipo_ausentismo}</TableCell>
                  <TableCell>{record.nombre_tipo_ausentismo}</TableCell>
                  <TableCell>

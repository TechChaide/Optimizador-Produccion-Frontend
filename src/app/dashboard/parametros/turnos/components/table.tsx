    ...
    <Card>
      <CardHeader className="flex items-center justify-between">
        <div>
          ...
          <CardDescription>Turnos disponibles en el sistema.</CardDescription>
        </div>
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? renderSkeleton() : paginated.map(record => (
                <TableRow key={record.codigo_turno}>
                  <TableCell className="font-medium">{record.codigo_turno}</TableCell>
                  <TableCell>{record.nombre_turno}</TableCell>
                  <TableCell>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={async () => {
                          if (!confirm('¿Confirma eliminar este turno?')) return;
                          try {
                            await turnoService.delete(record.codigo_turno);
              ...
              {!isLoading && paginated.length === 0 && (
                <TableRow>
                  <TableCell colSpan={4} className="h-24 text-center">No se encontraron turnos.</TableCell>
                </TableRow>
              )}
            </TableBody>
          </Table>
